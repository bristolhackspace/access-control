...
class InductionController extends Controller
{
    public function index()
    {
        ...
        return view('admin.inductions.index', compact('inductions'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.inductions.create', compact('inducted_bies', 'machines', 'users'));
    }
    ...
    public function store(StoreInductionRequest $request)
    {
        ...
        return redirect()->route('admin.inductions.index');
    }
    ...
    public function edit(Induction $induction)
    {
        ...
        return view('admin.inductions.edit', compact('inducted_bies', 'induction', 'machines', 'users'));
    }
    ...
    public function show(Induction $induction)
    {
        ...
        return view('admin.inductions.show', compact('induction'));
    }
