    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', 'joining') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::STANDING_ORDER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('standing_order') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="standing_order_{{ $key }}" name="standing_order" value="{{ $key }}" {{ old('standing_order', 'no') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('standing_order_name') ? 'is-invalid' : '' }}" type="text" name="standing_order_name" id="standing_order_name" value="{{ old('standing_order_name', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('direct_debit') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="direct_debit" id="direct_debit" value="1" {{ old('direct_debit', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('welcome_email') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="welcome_email" id="welcome_email" value="1" {{ old('welcome_email', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('mailchimp') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="mailchimp" id="mailchimp" value="1" {{ old('mailchimp', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::DISCOURSE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('discourse') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="discourse_{{ $key }}" name="discourse" value="{{ $key }}" {{ old('discourse', 'no') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('postal_address') ? 'is-invalid' : '' }}" name="postal_address" id="postal_address">{!! old('postal_address') !!}</textarea>
