                    ...
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\User::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $user->status) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\User::STANDING_ORDER_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="standing_order_{{ $key }}" name="standing_order" value="{{ $key }}" {{ old('standing_order', $user->standing_order) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="standing_order_name" id="standing_order_name" value="{{ old('standing_order_name', $user->standing_order_name) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="direct_debit" id="direct_debit" value="1" {{ $user->direct_debit || old('direct_debit', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="welcome_email" id="welcome_email" value="1" {{ $user->welcome_email || old('welcome_email', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="mailchimp" id="mailchimp" value="1" {{ $user->mailchimp || old('mailchimp', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\User::DISCOURSE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="discourse_{{ $key }}" name="discourse" value="{{ $key }}" {{ old('discourse', $user->discourse) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="postal_address" id="postal_address">{!! old('postal_address', $user->postal_address) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="membership_end_date" id="membership_end_date" value="{{ old('membership_end_date', $user->membership_end_date) }}">
                            @if($errors->has('membership_end_date'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('membership_end_date') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="notes" id="notes">{!! old('notes', $user->notes) !!}</textarea>
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
