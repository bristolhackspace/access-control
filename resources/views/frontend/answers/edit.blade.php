                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.answers.update", [$answer->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="order" id="order" value="{{ old('order', $answer->order) }}" step="1">
                            @if($errors->has('order'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('order') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="text" id="text" value="{{ old('text', $answer->text) }}" required>
                            @if($errors->has('text'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('text') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="correct" id="correct" value="1" {{ $answer->correct || old('correct', 0) === 1 ? 'checked' : '' }}>
