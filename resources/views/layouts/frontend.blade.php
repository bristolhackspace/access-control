                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('machine_access')
                                        <a class="dropdown-item" href="{{ route('frontend.machines.index') }}">
                                            {{ trans('cruds.machine.title') }}
                                        </a>
                                    @endcan
                                    @can('induction_access')
                                        <a class="dropdown-item" href="{{ route('frontend.inductions.index') }}">
                                            {{ trans('cruds.induction.title') }}
                                        </a>
                                    @endcan
                                    @can('login_access')
                                        <a class="dropdown-item" href="{{ route('frontend.logins.index') }}">
                                    ...
                                    @endcan
                                    @can('answer_access')
                                        <a class="dropdown-item" href="{{ route('frontend.answers.index') }}">
